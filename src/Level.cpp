...
bool Level::load_files()
{
    ...
    waka = Mix_LoadWAV("resources/sounds/Waka.wav");
    death = Mix_LoadWAV("resources/sounds/Dying.wav");
    eatingCherry = Mix_LoadWAV("resources/sounds/Eat Cherry.wav");
    extraLife_Audio = Mix_LoadWAV("resources/sounds/Extra Life.wav");
